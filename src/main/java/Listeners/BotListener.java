...
public class BotListener extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        Command command = Command.getCommandFromString(content);
        switch (Objects.requireNonNull(command)) {
            ...
            case Register_Participant:
                if (guild == null && props.size() == 3) {
                    ...
                    String tournamentId = lastMessage.substring(lastMessage.indexOf("#:") + 2);
                    ...
                    if (!channel.getName().equals("Tournament-Registration")) {
                        ...
                        //tournamentId = tournamentId.substring(tournamentId.indexOf("#:") + 2);
